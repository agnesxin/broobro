...
var checkboxMsgMap = {
	...
	"xdt": '<input type="checkbox" name="CheckboxGroup8" value="checkbox" id="CheckboxGroup8_0">T波改变<input type="checkbox" name="CheckboxGroup8" value="checkbox" id="CheckboxGroup8_1">ST改变<input type="checkbox" name="CheckboxGroup8" value="checkbox" id="CheckboxGroup8_2">ST-T改变其他<input type="text"></p><strong><p>请参考以下建议：①观察心电图；     ②必要时药物治疗；  ③建议专科医院进一步检查、治疗。</p></strong>',

...
var checkboxMsgMap = {
	...
	"xdt": '<input type="checkbox" name="CheckboxGroup8" value="checkbox" id="CheckboxGroup8_0">&nbspT波改变&nbsp&nbsp&nbsp&nbsp<input type="checkbox" name="CheckboxGroup8" value="checkbox" id="CheckboxGroup8_1">&nbspST改变&nbsp&nbsp&nbsp&nbsp<input type="checkbox" name="CheckboxGroup8" value="checkbox" id="CheckboxGroup8_2">&nbspST-T改变&nbsp&nbsp&nbsp&nbsp其他<input type="text"></p><strong><p>请参考以下建议：①观察心电图；     ②必要时药物治疗；  ③建议专科医院进一步检查、治疗。</p></strong>',
	...
	"zhifanggan": '&bull; 脂肪肝：<input type="checkbox" name="CheckboxGroup9" value="checkbox" id="CheckboxGroup9_0">轻度<input type="checkbox" name="CheckboxGroup9" value="checkbox" id="CheckboxGroup9_1">中度<input type="checkbox" name="CheckboxGroup9" value="checkbox" id="CheckboxGroup9_2">重度<ul><strong>注意事项：①低脂肪、低胆固醇饮食。   ②禁酒    ③控制体重（超标者应减体重）。 ④适当增加身体锻炼。       ⑤必要时服降脂药。   ⑥有糖尿病者，应控制糖尿病。 </strong>',
	...
	"danjieshi": '&bull; 胆囊结石： 大小<input class="input-mini" style="text-align:center;" type="text"> cm；多发： 大者<input class="input-mini" style="text-align:center;" type="text">cm；<p><input type="checkbox" name="CheckboxGroup10" value="checkbox" id="CheckboxGroup10_0">泥沙型<input type="checkbox" name="CheckboxGroup10" value="checkbox" id="CheckboxGroup10_1">充满型<p><strong>建议：①定期检查      ②清淡饮食    ③消炎利胆排石</strong>',
	...
	"xzUn": '肝脏异常项：<input type="checkbox" name="CheckboxGroup3" value="checkbox" id="CheckboxGroup3_0" onClick="OnChangeCheckbox(this, \'zhifanggan\')">&nbsp脂肪肝&nbsp&nbsp&nbsp&nbsp<input type="checkbox" name="CheckboxGroup3" value="checkbox" id="CheckboxGroup3_1" onClick="OnChangeCheckbox(this, \'gnghz\')">&nbsp肝内钙化灶&nbsp&nbsp&nbsp&nbsp<input type="checkbox" name="CheckboxGroup3" value="checkbox" id="CheckboxGroup3_2" onClick="OnChangeCheckbox(this, \'gannangzhong\')">&nbsp肝囊肿&nbsp&nbsp&nbsp&nbsp</p><p id="zhifanggan"></p><p id="gnghz"></p><p id="gannangzhong"></p>胆囊：<input type="checkbox" name="CheckboxGroup4" value="checkbox" id="CheckboxGroup4_0" onClick="OnChangeCheckbox(this, \'danjieshi\')">&nbsp胆囊结石&nbsp&nbsp&nbsp&nbsp<input type="checkbox" name="CheckboxGroup4" value="checkbox" id="CheckboxGroup4_1" onClick="OnChangeCheckbox(this, \'danzenghou\')">&nbsp胆囊壁增厚性改变&nbsp&nbsp&nbsp&nbsp<input type="checkbox" name="CheckboxGroup4" value="checkbox" id="CheckboxGroup4_2" onClick="OnChangeCheckbox(this, \'danxirou\')">&nbsp胆囊壁息肉样改变&nbsp&nbsp&nbsp&nbsp<input type="checkbox" name="CheckboxGroup4" value="checkbox" id="CheckboxGroup4_3" onClick="OnChangeCheckbox(this, \'danqiechu\')">&nbsp胆囊术后<p id="danjieshi"></p><p id="danzenghou"></p><p id="danxirou"></p><p id="danqiechu"></p>肾脏异常项： <input type="checkbox" name="CheckboxGroup11" value="checkbox" id="CheckboxGroup11_0" onClick="OnChangeCheckbox(this, \'shenjieshi\')">&nbsp肾结石&nbsp&nbsp&nbsp&nbsp<input type="checkbox" name="CheckboxGroup11" value="checkbox" id="CheckboxGroup11_1" onClick="OnChangeCheckbox(this, \'shennangzhong\')">&nbsp肾脏囊肿<p id="shenjieshi"></p><p id="shennangzhong"></p>'
};

function OnChangeCheckbox(checkbox, id, normal) {
